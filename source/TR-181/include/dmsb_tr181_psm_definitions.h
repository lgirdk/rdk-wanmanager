...
#define PSM_WANMANAGER_IPV6_ADDR_MON_ENABLE                 "dmsb.wanmanager.IPv6AddrMonEnable"
...
#define PSM_WANMANAGER_IF_VIRIF_IP_RTABLE                   "dmsb.wanmanager.if.%d.VirtualInterface.%d.IP.RTable"
#define PSM_WANMANAGER_IF_VIRIF_IP_DNSCFGPATH               "dmsb.wanmanager.if.%d.VirtualInterface.%d.IP.DNSCfgPath"
